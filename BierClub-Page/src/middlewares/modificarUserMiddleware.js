...
let modificarUserMiddleware = [
  ...
  check("email")
    .notEmpty()
    .withMessage("La dirección email no puede estar vacía")
    .isEmail()
    .withMessage("La dirección email debe ser un válida"),
  check("antiguaContrasenia")
    .notEmpty()
    .withMessage("Este campo no puede estar vacío")
    .isLength({ min: 8 })
    .withMessage("Este campo debe tener al menos 8 caracteres"),
  check("contrasenia")
    .notEmpty()
    .withMessage("La contraseña no puede estar vacía")
    .isLength({ min: 8 })
    .withMessage("La contraseña debe tener al menos 8 caracteres"),
  check("confirmarContrasenia")
    .notEmpty()
    .withMessage("Este campo no puede estar vacío")
    .isLength({ min: 8 })
    .withMessage("Este campo debe tener al menos 8 caracteres"),
