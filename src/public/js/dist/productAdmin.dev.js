...
var dropDownFiltros = function dropDownFiltros(idAModificar, claseATomarPropiedades) {
...
function eliminarProducto(productoId) {
  document.getElementById('eliminar-' + productoId).classList.toggle('modalEliminarProducto');
